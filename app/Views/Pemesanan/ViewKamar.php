...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Pesan Kamar Kos <?= $namakos?></h1>
                            ...
                            if($i==1){
                                ?>
                                    <li class="<?= $atr?>">
                                        ...
                                        <a href="<?= base_url('pemesanan/add/'.$row->id_kamar.'/'.$namakos) ?>" class="<?= $atr3?>" role="button"><?=$tombol?></a>
                                        <br>
                                        <?php
                                            //jika tombol terisi ada tombol pindah kamar
                                            if($tombol == "Terisi"){
                                                ?>
                                                    <a href="<?= base_url('pemesanan/pindah/'.$row->id_kamar.'/'.$row->id_kos.'/'.$namakos) ?>" class="btn btn-warning btn-sm" role="button">Pindah</a>
                                                <?php
                                            }
                                        ?>
                                    </li>
