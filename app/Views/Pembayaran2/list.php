      ...
      <input type="hidden" name="result_data" id="result-data" value=""></div>
        ...
        <div class="container">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama" id="nama" value="<?=$nama_pelanggan?>" readonly>
                <label for="nama" class="form-label">Total Penjualan</label>
                <input type="text" class="form-control" name="byr" id="byr" value="<?=$harga_penjualan?>" readonly>
